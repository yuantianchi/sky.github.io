...
在社区具有很大的热度，是一个基于四层、具有强大性能的反向代理服务器,从Linux2.4内核以后，已经完全内置了LVS的各个功能模块。</font><br/>
...
#LVS的三种调度模式：NAT（地址转换）、DR（直接路由）、TUN（隧道）
...
###拓扑图：
![avatar](../posts_image/LVS介绍/lvs_img/lvs-nat-01.png)
...
###拓扑图
![avatar](../posts_image/LVS介绍/lvs_img/lvs-dr-01.png)
...
###拓补图
![avatar](../posts_image/LVS介绍/lvs_img/lvs-TUN-01.png)
###LVS-TUN的优点与缺点
####优点：
